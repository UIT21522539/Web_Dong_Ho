<link rel="stylesheet" href="{{ asset('assets/css/Admin/userlist.css')}}">
    ...
    <div class="user-body-content"> 
        <form action="{{ route('users.search') }}" method="GET">
            <div class="mb-3">
                ...
                <input type="text" name="search" placeholder="Tìm kiếm khách hàng theo tên" class="form-control" id="search" value="{{ request('search') }}">
